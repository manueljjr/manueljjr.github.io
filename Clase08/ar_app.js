...
function init() {
    ...
    let markerControl = new THREEx.ArMarkerControls(arToolkitContext, markerRoot1, {
        ...
        type: 'pattern', patternUrl: 'data/pattern-marcador1.patt',
    });
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('jinx.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('jinx.obj', function (group) {
    ...
    //  new THREE.MTLLoader()
    //  .setPath('data/models/')
    //  .load('molde01.mtl', function (materials) {
    //      materials.preload();
    //      new THREE.OBJLoader()
    //          .setMaterials(materials)
    //          .setPath('data/models/')
    //          .load('molde01.obj', function (group) {
    //              RhinoMesh = group.children[0];
    //              RhinoMesh.material.side = THREE.DoubleSide;
    //              RhinoMesh.scale.set(0.025, 0.025, 0.025);
    //              RhinoMesh.castShadow = true;
    //              RhinoMesh.receiveShadow = true;
    //              RhinoMesh.position.set(-2,0,0);
